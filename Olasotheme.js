 ...
 * Generated: 2026-07-28T15:23:10.128Z
 */

/**
 * Olasotheme theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { OlasothemeTheme } from './Olasotheme';
 *   import './Olasotheme.css';
 */
export const OlasothemeTheme = {
  name: 'Olasotheme',
  __built: true,
  tokens: {
    "--color-accent": "light-dark(#006A2B, #9DDBAE)",
    "--color-accent-muted": "light-dark(#006A2B14, #9DDBAE20)",
    "--color-on-accent": "light-dark(#FFFFFF, #062B16)",
    "--color-neutral": "light-dark(#1016110F, #DDE3D91A)",
    "--color-background-surface": "light-dark(#FFFFFF, #151B16)",
    "--color-background-body": "light-dark(#F8F7EA, #101611)",
    "--color-overlay": "light-dark(#10161180, #101611CC)",
    "--color-overlay-hover": "light-dark(#006A2B0D, #9DDBAE0D)",
    "--color-overlay-pressed": "light-dark(#006A2B1A, #9DDBAE1A)",
    "--color-background-muted": "light-dark(#FAFAF7, #253029)",
    "--color-text-primary": "light-dark(#101611, #F8F7EA)",
    "--color-text-secondary": "light-dark(#566057, #B9C4BB)",
    "--color-text-disabled": "light-dark(#A8B0A9, #68736A)",
    "--color-text-accent": "light-dark(#006A2B, #9DDBAE)",
    "--color-on-dark": "#FFFFFF",
    "--color-on-light": "#101611",
    "--color-icon-accent": "light-dark(#006A2B, #9DDBAE)",
    "--color-icon-primary": "light-dark(#101611, #F8F7EA)",
    "--color-icon-secondary": "light-dark(#566057, #B9C4BB)",
    "--color-icon-disabled": "light-dark(#A8B0A9, #68736A)",
    "--color-background-card": "light-dark(#FFFFFF, #1A211C)",
    "--color-background-popover": "light-dark(#FFFFFF, #1A211C)",
    "--color-background-inverted": "light-dark(#006A2B, #9DDBAE)",
    ...
    "--color-border": "light-dark(#DDE3D9, #DDE3D91A)",
    "--color-border-emphasized": "light-dark(#0B6B36, #9DDBAE)",
    "--color-skeleton": "light-dark(#DDE3D9, #566057)",
