...
- The current repository includes a Convex development backend and live product
  management. Do not imply that planned SQLite, Capacitor, production
  authentication, or ESC/POS behavior already exists.
