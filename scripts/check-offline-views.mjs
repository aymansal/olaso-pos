...
assert.match(reports, /function hasSameSales/);
assert.match(reports, /local\.current\.orderCount > cloud\.current\.orderCount/);
assert.match(reports, /local\.current\.itemCount === cloud\.current\.itemCount/);
assert.match(reports, /local\.current\.netCentimes === cloud\.current\.netCentimes/);
assert.match(reports, /profileTotals: local\.current\.profileTotals/);
