...
| Goal 03 | Production checkout and Android LAN ESC/POS printing | active; PRINT-05 closeout | goals/GOAL-03-PRINTING-INTEGRATION.md |
...
Continue Goal 03 from PRINT-05 closeout. Later cards remain pending until the
