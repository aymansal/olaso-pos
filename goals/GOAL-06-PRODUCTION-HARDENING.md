...
**Status:** active; CATALOG-01 is the only card in progress
...
| CATALOG-01 | Add offline category artwork selection and a neutral custom-category fallback | in progress | Six transparent 320 px lossless WebP assets, neutral resolver, picker, schema 17, complete local/cloud propagation, full automated/Convex/Android beta checks, physical migration/offline create-edit/restart/reconnect/cleanup, exact 1340 × 800 UI, clean lifecycle/network/console proof, Graphify, authorities, and DOX pass; ready to commit/push |
...
- Goal 06 remains active on `main`; LOCAL-01 through STAFF-01 are done and
  CATALOG-01 is the only card in progress.
