...
| HARD-07 | Complete security, privacy, dependency, quota, and support readiness review | done | `bb9279350c95779b1503964bb8dd80d4322c2a3c` |
...
| SYNC-03 | Do not skip sale drain when management processed/failed in-batch | done — SHA recorded after push | same ledger |
...
- HARD-07 is on `origin/main` as `bb9279350c95779b1503964bb8dd80d4322c2a3c`
  (release non-debuggable, monitoring notes, Tab A9 About `Version 1.1`).
  Exact next action: OPTIONS-01 when the owner continues.
