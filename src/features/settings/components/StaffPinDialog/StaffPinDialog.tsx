...
export function StaffPinDialog({
  ...
  return (
    <OverlayPortal>
      <div className={styles.overlay} role="presentation" onPointerDown={(event) => closeOnBackdrop(event, onClose)}>
        <section className={styles.dialog} role="dialog" aria-modal="true" aria-labelledby="staff-pin-title">
          <header>
            ...
            <button type="button" onClick={onClose} aria-label={t('Close PIN form')}><X width={18} height={18} /></button>
          </header>
